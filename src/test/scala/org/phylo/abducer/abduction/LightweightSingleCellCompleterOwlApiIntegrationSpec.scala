...
final class LightweightSingleCellCompleterOwlApiIntegrationSpec extends AnyFunSuite {
  ...
  private val owlNothingIri = IRI.create("http://www.w3.org/2002/07/owl#Nothing")

  test("completer uses ELK-backed consistency checks to reject owl:Nothing candidate") {
